...
const ULeftPanel = ({ view, area, tab, gp, overlays, onOverlay, brandFilter, onBrand, gapRules, onAddRule, onRemoveRule, onToggleRule, catchment, onCatchment, catchStats, sketch, onSketch, session, onRenameSketch, onSaveSketch, onExitSketch, saved, onOpenSaved }) => {
