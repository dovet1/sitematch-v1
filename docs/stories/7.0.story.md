...
**I want to** see comprehensive information about SiteMatch's value, process, and credibility below the hero section  
...
const HeadingStructure = {
  h1: "SiteMatch - Commercial Property Matching", // Page title
...
const getAltText = (type: string, context: string) => {
  switch(type) {
    ...
    case 'founder-photo':
      return `Professional photo of ${context}, founder of SiteMatch`;
    case 'process-icon':
