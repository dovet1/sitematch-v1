...
**Logo.dev API Details (Migrated from Clearbit):**
- Requires public token (sign up at https://www.logo.dev/signup)
- URL format: `https://img.logo.dev/{domain}?token={token}`
...
- Attribution: "Logos provided by Logo.dev" in footer
