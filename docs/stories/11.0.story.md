...
5. All existing SiteMatch dev team users are migrated to the new authentication method
...
Since all existing users are SiteMatch dev team members, we'll use a manual migration approach:
