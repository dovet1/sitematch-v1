...
/* ===== Top bar ===== */
const SSTopBar = ({ projectName = "Untitled sketch", searchValue = "", showResults = false, isLoggedIn = true }) => (
  <div style={{
    ...
    <div style={{ display: "flex", alignItems: "center", gap: 8, minWidth: 0 }}>
      ...
      <span style={{ fontFamily: "Inter", fontSize: 13, color: SS.ink, fontWeight: 500 }}>{projectName}</span>
      <span style={{
    ...
    {isLoggedIn && (
      <span style={{
        width: 30, height: 30, borderRadius: 999, background: SS.violet,
        color: "#FFF", fontFamily: "Inter", fontSize: 12, fontWeight: 600,
...
const SSLeftRail = ({ active = "select", panel = null, onPick }) => (
  <div style={{
    ...
    {TOOL_LIST.map(t => (
      <SSToolBtn key={t.id} icon={t.icon} label={t.label} shortcut={t.shortcut}
