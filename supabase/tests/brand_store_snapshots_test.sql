-- brand_store_snapshots tests (20260905000000_create_brand_store_snapshots.sql).
--
...
-- emptied county disappears, and whether RLS really keeps the table off the anon client.
...
SELECT public.snapshot_brand_stores(:month::date);
...
BEGIN
  ...
  PERFORM public.snapshot_brand_stores(DATE '2026-06-01');
...
DECLARE v_rows integer;
BEGIN
  PERFORM public.snapshot_brand_stores(DATE '2026-05-17');
  SELECT count(*)::integer INTO v_rows FROM public.brand_store_snapshots
