...
const sources = [
  ...['ingest', 'plota', 'eligibility', 'commercial-description', 'linking', 'link-ingest', 'family-lookup', 'family-priority', 'assessment-groups', 'development-membership', 'membership-ingest', 'family-topup', 'family-input', 'types', 'db', 'classify', 'budget', 'openrouter', 'discovery-lane-route']
