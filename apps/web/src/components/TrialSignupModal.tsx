  ...
  useEffect(() => {
    const proceedToCheckout = async () => {
      if (user && (open || forceOpen)) {
        ...
        try {
          // User is already logged in, skip account creation and go straight to checkout
    ...
    proceedToCheckout()
  }, [user, open, forceOpen, context, redirectPath, onLoadingChange])
