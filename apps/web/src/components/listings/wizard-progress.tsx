                ...
                <div
                  className={cn(
                    'flex items-center justify-center w-10 h-10 rounded-full border-2 font-medium text-sm transition-all duration-200',
                    {
                      ...
                      // Active step
                      'bg-blue-600 border-blue-600 text-white': isActive && !isCompleted,
...
export function createProgressSteps(currentStep: 1 | 2, stepValidation: Record<number, boolean>): ProgressStep[] {
  return [
    {
      number: 1,
