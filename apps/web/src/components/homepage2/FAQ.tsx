      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mt-12 text-center p-8 bg-gradient-to-r from-violet-50 to-purple-50 rounded-2xl border border-violet-200">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-violet-600 text-white font-semibold rounded-xl hover:bg-violet-700 transition-colors duration-200"
          >
            Contact Support
          </a>
        </div>
