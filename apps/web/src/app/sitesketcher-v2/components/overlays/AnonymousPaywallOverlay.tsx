          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <Check className="w-4 h-4 text-[#7033FF] flex-shrink-0 mt-0.5" />
                <span className="text-[13.5px] text-[#171419] font-inter leading-[1.5]">
                  Unlimited polygons, parking, and measurements
                </span>
              </li>
              <li className="flex items-start gap-2">
                <Check className="w-4 h-4 text-[#7033FF] flex-shrink-0 mt-0.5" />
          ...
          <div className="bg-white p-8 md:p-10 flex flex-col justify-center">
            <div className="space-y-6">
              ...
              <div>
                ...
                >
                  Sign up to use SiteSketcher
                </h2>
                <p id="paywall-description" className="text-[14px] text-[#7C7588] font-inter">
                  Create a free account to start sketching site layouts
                </p>
              </div>
              ...
              <div className="space-y-3">
                <button
                  onClick={() =>
                    router.push(`/auth?mode=signup&returnUrl=${encodeURIComponent('/sitesketcher')}`)
                  }
