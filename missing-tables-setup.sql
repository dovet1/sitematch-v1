...
-- 5. Enable Row Level Security (optional, for production use)
...
SELECT 'listing_locations table created' as status;
SELECT 'listing_contacts table created' as status;
SELECT 'file_uploads table created' as status;

-- Show the table structures
\d public.listing_locations;
\d public.listing_contacts;
